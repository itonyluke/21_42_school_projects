...
|   | [ft_server](https://github.com/itonyluke/ft_server) | discover Docker and set up a web server | `system administration` `scripting` `best practices writing Dockerfiles` `compose YAML files` `Docker/Compose/Daemon CLI` `setting up a web server (NGINX) that runs multiple services: Wordpress, phpMyAdmin, and a SQL database.`
